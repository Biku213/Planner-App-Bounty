...
import TicTacToeWidget from '../widgets/MyCustomWidget'; // Import the TicTacToeWidget component
...
export default function WidgetGalleryModal({ setShowWidgetModal, selectedWidgetArea, widgets, setWidgets,  }) {
  const [galleryWidgets, setGalleryWidgets] = useState([
    ...
    { component: <TicTacToeWidget />, name: 'Tic Tac Toe' }, // Add the TicTacToeWidget to the gallery
  ])
  return (
    <div className="modal"
      onClick={(e) => {
